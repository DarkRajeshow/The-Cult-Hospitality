...
const CardSpotlight: React.FC<CardSpotlightProps> = ({ children, className = "" }) => {
  return (
    <div className={`group relative overflow-hidden rounded-lg border border-gray-200 bg-white/50 backdrop-blur-sm transition-all duration-300 hover:border-blue-300 hover:shadow-lg ${className}`}>
